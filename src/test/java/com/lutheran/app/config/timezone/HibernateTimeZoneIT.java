package com.lutheran.app.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.lutheran.app.IntegrationTest;
import com.lutheran.app.repository.timezone.DateTimeWrapper;
import com.lutheran.app.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM lutheran_date_time_wrapper where id=%d", fieldName, id);
    }
