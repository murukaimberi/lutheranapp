...
public interface LocationRepository extends JpaRepository<Location, Long> {
    ...
    @Query(
        value = "select distinct location from Location location left join fetch location.congregant",
    ...
    @Query("select distinct location from Location location left join fetch location.congregant")
    List<Location> findAllWithToOneRelationships();

    @Query("select location from Location location left join fetch location.congregant where location.id =:id")
