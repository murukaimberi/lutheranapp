...
describe('Location Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    ...
    it('Should call Congregant query and add missing value', () => {
      const location: ILocation = { id: 456 };
      const congregant: ICongregant = { id: 90730 };
      location.congregant = congregant;

      const congregantCollection: ICongregant[] = [{ id: 2279 }];
    ...
    it('Should update editForm', () => {
      ...
      location.country = country;
      const congregant: ICongregant = { id: 20793 };
      location.congregant = congregant;
